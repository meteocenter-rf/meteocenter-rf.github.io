...
def get_portal_html(city_name="Москва", req_path="/"):
            ...
            },
            {
                ...
                "mainEntity": [
                    ...
                    },
                    {
                        ...
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": f"Обычные мобильные виджеты отображают интерполированные расчеты с высокой погрешностью. Наш портал агрегирует открытые данные наблюдений государственной сети метеостанций ВМО (термометры в будках Стивенсона, барометры, флюгеры), выводя реальную фактическую температуру, точку росы и давление."
                        }
                    },
                    {
                        "@type": "Question",
    ...
    if "{{SEO_TITLE}}" in html:
        ...
        html = html.replace("Погода в Москве — архив погоды за 120+ лет (1890–2026), радар осадков онлайн, метеостанции ВМО и 4 суперкомпьютера", title)
        html = html.replace("https://meteocenter-rf.github.io/", canonical)
